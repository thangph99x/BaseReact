      ...
      <Row className="match-height">
        ...
        <Col xl="6" lg="12">
          ...
          <Card title="Sizes" code={avatarSizes}>
            ...
            <CardText className="mb-0">
               Use <code>size=[sm | lg | xl]</code> prop to
              change avatar's size. You can also use <code>height</code> & 
        ...
        <Col xl="6" lg="12">
          ...
          <Card title="Intials" code={avatarInitials}>
            ...
            <CardText className="mb-0">
               Use prop <code>initials</code> to show only
              Initials of content.
            </CardText>
        ...
        <Col xl="6" lg="12">
          ...
          <Card title="Icons" code={avatarIcons}>
            ...
            <CardText className="mb-0">
               Use prop <code>icon</code> to create avatar
              with icon.
            </CardText>
        ...
        <Col xl="6" sm="12">
          ...
          <Card title="Avatar Group" code={avatarGroup}>
            ...
            <CardText>
               Use <code>&lt;AvatarGroup /&gt;</code>{" "}
              component and pass <code>data</code> prop to create a grouped
              avatar.
            </CardText>
        ...
        <Col xl="6" sm="12">
          ...
          <Card title="Avatar Group Tooltip" code={avatarGroupTooltip}>
            ...
            <CardText>
               Add an extra property of <code>title</code> in
              the data you pass in <code>&lt;AvatarGroup /&gt;</code> to create
